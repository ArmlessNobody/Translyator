...
def insert():
    ...
    while i < (len(list_numbers_rank)):
        bla_bla = len(list_numbers_rank)
        if i + 3 < len(list_numbers_rank):
            if list_numbers[i] == "quatre" and list_numbers[i + 1] == "vingt" and list_numbers[i+2] == 'dix' and list_numbers_rank[i+3].rank == 2:
                ...
                i = i + 3;
        elif i + 2 < len(list_numbers_rank):
            print("i+2")
            if list_numbers_rank[i] == 4 and list_numbers[i + 1] == "et" and list_numbers[i + 2] == "un":
                ...
                res_number += list_numbers_rank[i].numbers + list_numbers_rank[i + 1].numbers + list_numbers_rank[
                    i + 2].numbers;
                i = i +2;
            elif list_numbers[i] == "quatre" and list_numbers[i+1] == "vingt" and list_numbers_rank[i+2].rank == 3:
                res_number += list_numbers_rank[i].numbers * list_numbers_rank[i+1].numbers + list_numbers_rank[i+2].numbers;
                i = i + 2;
        elif i + 1 < len(list_numbers_rank):
            print("i+1")
            if list_numbers[i] == "quatre" and list_numbers[i+1] == "vingts":
            ...
            elif (list_numbers_rank[i].rank == 1 or list_numbers_rank[i].rank == 2) and list_numbers_rank[
                i + 1].rank == 5:
                if list_numbers[i] == "un" and list_numbers[i + 1] == "cent":
                    ...
                    flag_break2 = 1;
                    temp_text = "Нельзя использовать разряд единиц '" + list_numbers[
                        i] + "' перед разрядом сотен 'cent'!";
                    break;
                flag_hundreds = 1;
                res_number += list_numbers_rank[i].numbers * list_numbers_rank[i + 1].numbers;
                i = i +2;
                ...
                if list_numbers[i] == "soixante":
                    ...
                    temp_text = "Разряд десятков '" + list_numbers[i] + "' " + "не может стоять перед разрядом '" + \
                                list_numbers[i + 1] + "'!";
                    break;
            elif list_numbers_rank[i].rank == 3 and list_numbers[i] != "dix" and (
