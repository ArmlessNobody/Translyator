    ...
    if flag_break == 0:
        while i < (len(list_numbers_rank)):
            if (i + 3 < len(list_numbers_rank)) and list_numbers[i] == "quatre" and list_numbers[i + 1] == "vingt" and list_numbers[i + 2] == 'dix' and list_numbers_rank[i + 3].rank == 2:
                ...
                flag_break2 = 1;
                break;
            elif i - 1 > 0 and list_numbers_rank[i-1].rank <= list_numbers_rank[i].rank:
                flag_break2 = 1;
                temp_text  =Eror(list_numbers_rank[i-1], list_numbers_rank[i], list_numbers[i-1], list_numbers[i]);
                break;
